...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="/admin/region">الاحياء</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>عرض الاحياء</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">عرض الاحياء
        <small>اضافة جميع الاحياء</small>
    </h1>
@endsection
...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <!-- BEGIN TAB PORTLET-->
            <form method="post" action="/admin/add/region" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-9">
                                                    <div class=" input-group select2-bootstrap-append">
                                                        <select  name="country" class="form-control select2-allow-clear">
