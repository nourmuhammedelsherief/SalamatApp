...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('Contacts')}}">خدمة العملاء</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>تعديل  خدمة العملاء</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">  خدمة العملاء
        <small>تعديل  خدمة العملاء</small>
    </h1>
@endsection
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet light ">
                            <form role="form" action="{{route('updateCall_center' , $call->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" placeholder="الاسم" class="form-control" value="{{$call->name}}" />
                                                @if ($errors->has('name'))
                                            ...
                                            <div class=" form-group">
                                                ...
                                                <input type="text" name="phone" placeholder="رقم الهاتف" class="form-control" value="{{$call->phone}}" />
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                                                @if ($call->photo !== null)
                                                                    <img src="{{asset('/uploads/call_center/'.$call->photo)}}">
                                                                @endif
                                                            </div>
                                                            <div>
