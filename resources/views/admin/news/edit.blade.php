...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>تعديل الاخبار</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">  الاخبار
        <small>تعديل الاخبار</small>
    </h1>
@endsection
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="portlet light ">
                            <form role="form" action="{{route('updateNews' , $news->id)}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane active" id="tab_1_1">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="user_name" placeholder="الاسم" class="form-control" value="{{$news->user_name}}" />
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                                                @if ($news->user_photo !== null)
                                                                    <img src="{{asset('/uploads/users/'.$news->user_photo)}}">
                                                                @endif
                                                            </div>
                                                            <div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" placeholder="اكتب  عنوان الخبر" class="form-control" value="{{$news->title}}" />
                                                @if ($errors->has('title'))
                                                    <span class="help-block">
                                            ...
                                            <div class="form-body">
                                                <div class="form-group ">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                                            <div class="fileinput-preview thumbnail" data-trigger="fileinput" style="width: 200px; height: 150px;">
                                                                @if ($news->news_photo !== null)
                                                                    <img src="{{asset('/uploads/news_photos/'.$news->news_photo)}}">
                                                                @endif
                                                            </div>
                                                            <div>
                                                            <span class="btn red btn-outline btn-file">
                                            ...
                                            <div class=" form-group">
                                                ...
                                                <textarea name="content" class="form-control" rows="5" placeholder="اكتب محتوي  الخبر"> {{$news->content}} </textarea>
