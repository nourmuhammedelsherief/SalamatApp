...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>عرض أرقام الاتصال</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">عرض أرقام الاتصال
        <small>عرض أرقام الاتصال</small>
    </h1>
@endsection
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" >
                        ...
                        @foreach($contacts as $contact)
                            <tr class="odd gradeX">
                                ...
                                <td> {{$contact->phone}} </td>
                                <td>
                                    <img src="{{asset('/uploads/contacts_photos/'.$contact->photo)}}" height="80" width="100">
                                </td>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            <li>
                                                <a class="delete_offer" data="{{$contact->id}}" data_name="{{$contact->name}}" >
