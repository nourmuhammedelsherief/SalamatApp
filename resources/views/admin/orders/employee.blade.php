...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="/admin/order/employee">طلبات موظف</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>عرض طلبات موظف</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">عرض طلبات موظف
        <small>عرض جميع طلبات موظف</small>
    </h1>
@endsection
                    ...
                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                        ...
                        @foreach($places as $data)
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td> {{\App\City::find($data->to_region_id)->name}} </td>
                                    <td>
