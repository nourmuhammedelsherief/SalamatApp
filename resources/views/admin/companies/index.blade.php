...
@section('page_header')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="/admin/company">الشركة المصنعة</a>
                <i class="fa fa-circle"></i>
            </li>
            <li>
                <span>عرض الشركة المصنعة</span>
            </li>
        </ul>
    </div>

    <h1 class="page-title">عرض الشركة المصنعة
        <small>عرض الشركة المصنعة</small>
    </h1>
@endsection
                                  ...
                                  <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-left" role="menu">
                                            ...
                                            <li>
                                                <a href="/admin/edit/company/{{$place->id}}">
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.delete_offer', function() {
                ...
                swal({
                    ...
                    window.location.href = "{{ url('/') }}" + "/admin/delete/"+id+"/company";
